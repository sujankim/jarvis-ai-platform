...
class MemoryControllerTest {
    ...
    @Test
    @DisplayName("Test GET /api/memory - Should return user's memories")
    ...
    @DisplayName("Test POST /api/memory - Should return bad request for null memory type")
    ...
    @DisplayName("Test POST /api/memory - Should return bad request for blank memory content")
    ...
    @Test
    @DisplayName("Test DELTE /api/memory/{memoryId} - Should delete memory by id")
    ...
    @Test
    @DisplayName("Test DELTE /api/memory/{memoryId} - Should return bad request when invalid memory id provided")
    void testDeleteById_ShouldReturnBadRequestWhenInvalidIdProvided() {
        ...
        this.webTestClient
                .delete()
                .uri("/api/memory/{memoryId}", invalidMemoryId)
                .exchange()
                .expectStatus().isBadRequest();
    }

    @Test
    @DisplayName("Test DELTE /api/memory/{memoryId} - Should return not found when memory was not found by id")
    ...
    @Test
    @DisplayName("Test DELTE /api/memory - Should delete all memories")
